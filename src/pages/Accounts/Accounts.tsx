...
const Accounts = () => {
    ...
    return (
        <div className={'h-[calc(100%-40px)] max-h-screen overflow-hidden '}>
            <TopAccountPage title={'Tài khoản'}/>
            <div className="top pt-[2.188rem] pl-[2rem] flex gap-x-[3.688rem] pb-[2.5rem]">
                <div
                    ...
                    <div
                        className=" absolute top-0 left-0 flex-shrink-0 w-[21.5rem] h-[9.5625rem] rounded-[1.125rem] bg-[#0a8040]"/>
